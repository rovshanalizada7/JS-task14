...
// const person2 = new Employee ("Jhon","Sales",1200);
// person1.details();
...
// const manager = new Manager("a","b",500);
// const administrativeStaff = new AdministrativeStaff ("b","c",700)
// manager.details()
// administrativeStaff.details()
